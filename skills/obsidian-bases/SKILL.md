...
**Substrate preference (v1.7+)**: This skill is a self-contained fallback. **Prefer `kepano/obsidian-skills`** as the authoritative substrate when it is available — its `obsidian-bases` skill is the canonical reference for Bases YAML, formulas, and view definitions. The reference below keeps this vault functional without any external skill install. Official Bases docs: https://help.obsidian.md/bases/syntax
